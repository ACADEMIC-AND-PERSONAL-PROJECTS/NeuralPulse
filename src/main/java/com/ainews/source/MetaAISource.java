...
@Component
public class MetaAISource extends AbstractHtmlSource {

    private static final String BASE_URL = "https://ai.meta.com";
    ...
    public List<NewsItem> fetchLastWeek() {
        ...
        for (Element el : articles) {
            try {
                ...
                log.debug("Error parsing Meta AI article: {}", e.getMessage());
            }
        }
        return items;
    }
