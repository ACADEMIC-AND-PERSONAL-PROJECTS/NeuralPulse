...
@Component
public class MistralSource extends AbstractHtmlSource {

    private static final String BASE_URL = "https://mistral.ai";
    ...
    public List<NewsItem> fetchLastWeek() {
        ...
        Elements articles = doc.select("article, div[class*='card'], div[class*='post'], a[href*='/news/']");
        for (Element el : articles) {
            try {
                ...
                log.debug("Error parsing Mistral article: {}", e.getMessage());
            }
        }
        return items;
    }
