...
@Component
public class DeepMindSource extends AbstractHtmlSource {

    private static final String BASE_URL = "https://deepmind.google";
    ...
    public List<NewsItem> fetchLastWeek() {
        ...
        Elements articles = doc.select("article, div[class*='card'], div[class*='post'], a[href*='/blog/']");
        for (Element el : articles) {
            try {
                ...
                log.debug("Error parsing DeepMind article: {}", e.getMessage());
            }
        }
        return items;
    }
